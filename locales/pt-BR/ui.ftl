...
settings-skills-hint = Instala um snippet que ensina o agente (Claude Code, Codex, Antigravity) a usar o cadenza-cli. O snippet vai pro escopo escolhido (projeto atual ou global).
